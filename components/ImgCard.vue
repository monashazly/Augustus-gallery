...
<template>
    <div class=" rounded-md overflow-hidden hover:scale-105 transition shadow-md h-[300px] ">
        ...
        <div class="bg-slate-200 animate-pulse w-full h-full  aspect-square  " :id="'loader' + img.id">
        </div>
        <NuxtImg src="/placeholder.png" class="h-full w-full hidden" :id="'placeholder'+img.id "/>
        <!-- i tried to add thumbnail instead placeholder but it also takes too much time to render -->
    </div>
</template>